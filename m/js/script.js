...
for (let i = 0; i < dropList.length; i++) {
    for(let currency_code in country_list){
        // selecting USD by default as FROM currency and BDT as TO currency
...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/00f361c6f2cacd2228188f12/latest/${fromCurrency.value}`;
